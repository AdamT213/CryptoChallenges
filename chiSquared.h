...
class chiSquared { 
  ...
  double scoreText(std::string text) {
    ...
    charsByFrequency['\n'] = .0206;  charsByFrequency['g'] = .0203; charsByFrequency['p'] = .0182; charsByFrequency['\t'] = .0175;
     charsByFrequency['b'] = .0149; charsByFrequency[','] = .0144; 
    ...
    charsByAppearance['\0'] = 0; charsByAppearance['u'] = 0; charsByAppearance['c'] = 0; charsByAppearance['m'] = 0; charsByAppearance['f'] = 0; charsByAppearance['y'] = 0; charsByAppearance['w'] = 0;charsByAppearance['\n'] = 0; charsByAppearance['g'] = 0; charsByAppearance['p'] = 0; 
    charsByAppearance['\t'] = 0; charsByAppearance['b'] = 0; charsByAppearance[','] = 0; 
